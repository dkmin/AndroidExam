...
public class AndExam extends Activity {
	...
	void FillExample(int chapter) {
		...
		case 17: // 액티비티
			...
			break;
		case 18: // 프로세스
			arExample.add(new Example(ApplicationTest.class, "Application 객체 테스트")); //수정
			arExample.add(new Example(ApplicationKillActivity.class, "Application Kill 테스트")); //추가
			...
			arExample.add(new Example(MemoryTestActivity.class, "메모리릭 테스트하기"));
			break;
		case 19: // 스레드
